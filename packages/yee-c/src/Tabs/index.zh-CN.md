...
<code src="./demo/overflow-center.tsx" title="溢出时激活Tab居中" description="Tab较多出现下拉时，activeAlign=&quot;center&quot; 让从下拉选中的Tab滚动到Header中间"></code>
...
| activeAlign      | `'auto' \| 'center'`                                                                                           | Tab溢出时激活tab的对齐方式：`auto` 贴边最小滚动（完全可见时不滚动）；`center` 始终滚动到header中间居中，包括直接点击header上可见的tab | `auto`                                       |
