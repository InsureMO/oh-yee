...
<code src="./demo/overflow-center.tsx" title="Center Active Tab on Overflow" description="When tabs overflow into a dropdown, activeAlign=&quot;center&quot; scrolls the tab selected from the dropdown to the middle of the header"></code>
...
| activeAlign      | `'auto' \| 'center'`                                                                                           | How the active tab is aligned when the tab list overflows: `auto` scrolls minimally to the edge (no scrolling when already fully visible); `center` always scrolls it to the middle of the header, including tabs clicked directly on the header | `auto`                                                         |
