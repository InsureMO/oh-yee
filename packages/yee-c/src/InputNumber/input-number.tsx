...
const InputNumber = forwardRef<HTMLInputElement, InputNumberProps>(
    (baseprops, ref) => {
        ...
        function formatValue(val: number | null | undefined): string {
            ...
            let formattedVal = precision !== undefined
            ...
            <span className={cls} style={props.style}>
                ...
                {(suffix || allowClear || controls) && (
                    ...
                    >
                        ...
                        {controls && (
                            <span
                                className={clsx(`${prefixCls}-handler-wrap`, classNames?.handler)}
                                style={styles?.handler}
                            >
                                <span
                                    className={clsx(`${prefixCls}-handler`, `${prefixCls}-handler-up`, {
                                        [`${prefixCls}-handler-disabled`]:
                                            disabled || (mergedValue !== null && mergedValue >= max),
                                    })}
                                ...
                                <span
                                    className={clsx(`${prefixCls}-handler`, `${prefixCls}-handler-down`, {
                                        [`${prefixCls}-handler-disabled`]:
                                            disabled || (mergedValue !== null && mergedValue <= min),
                                    })}
