...
| initialValues        | `Store`                                                               | Initial values keyed by field name; nested fields use nested objects, e.g. `{ user: { name: 'tom' } }` | -                                                              |
| layout               | `'vertical' \| 'horizontal'`                                          | Layout                                   | -                                                              |
| onFinish             | `(values: Values) => void`                                            | Submit event callback                    | -                                                              |
| onFinishFailed       | `(errors: ValidateMessage[]) => void`                                | Submit error event callback              | -                                                              |
...
| clearFields           | `(name?: Name[]) => void`                                                                  | Clear fields (values and validation state; passing name only affects related fields)                                                 |
